% ANIMATEDATA	Cool little animation of the detection of peaks of the signal
%              recorded from the photodiode.
%
%   ANIMATEDATA(FILENAME, [SLEEPTIME]) is just a cool little useless animation 
...
%
function animatedata(filename, sleeptime);
...
for i=1:100:L
   ...
   plot((M:N)/1000, data(M:N,1),'cyan'); 
   plot((M:N)/1000, data(M:N,2),'green'); 
   plot((M:N)/1000, data(M:N,3),'black'); 

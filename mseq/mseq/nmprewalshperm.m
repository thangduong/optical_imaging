% NMPREWALSHPERM	This function is to supplement m-transform by doing a permutation
%
%    WALSHDATA = NMPREWALSHPERM(ORDER, SEED, MDATA, [LUT]) performs the permutation
...
%
%    NOTE: this is similar to PREWALSHPERM but without the mean element
%
%    EXAMPLE:
%      lut = createbcplut(3);
...
%  
% See also CREATEBCPLUT, NMPOSTWALSHPERM, NMFASTWALSH.
%

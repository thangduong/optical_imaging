...
public:
	...
	void LoadCameraList();
	CConfigureDlg(CConfiguratorView* pParent = NULL, IVideoSrc *pICap = NULL);
...
// Dialog Data
	...
	VS_PARAM_GROUP_TYPE m_rClickGroup;
	IVideoSrc *m_pCamera;
...
// Implementation
protected:
	void AddParamGroupsToTree(HTREEITEM parentTreeItem, VS_PARAM_GROUP_TYPE parentGroupID);
	...
	VS_PARAM_CAPS m_curParmCaps;
	VS_ACQ_PARAMS_TYPE m_curParamID;
	WORD m_wCurArrayDim;
	int m_iCurSelParam;

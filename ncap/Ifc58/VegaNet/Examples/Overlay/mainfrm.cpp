 ...
 *    $Logfile: /ifc/VegaNet/Examples/Overlay/mainfrm.cpp $
 *    $Revision: 1.1 $
 *    $Modtime: 2/12/01 10:00a $
 *
 * ABSTRACT
...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWnd)
	...
	ON_WM_GETMINMAXINFO()
	ON_UPDATE_COMMAND_UI(ID_IMAGESOURCE_IMGNODE, OnUpdateImageSourceImgnode)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
{
	pCmdUI->SetCheck(nUsedOverlay == SOFTWARE_OVERLAY);
}
...
void CMainFrame::OnUpdateImagesourceFrame(CCmdUI* pCmdUI) 
{
	...
	pCmdUI->Enable(pView->m_VideoSrcIsLocal);
...
void CMainFrame::OnUpdateImageSourceImgnode(CCmdUI* pCmdUI) 
{
	pCmdUI->SetCheck(nImageSource == NODE_IMG_SRC);

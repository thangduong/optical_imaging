 ...
 *    $Logfile: /ifc/examples/NetSightII/PulseGen/PulseGen.cpp $
 *    $Revision: 1.1 $
 *    $Modtime: 6/02/04 1:25p $
 *
 * ABSTRACT
...
BOOL CPulseGenApp::InitInstance()
{
	...
	if (!(m_pMod=(CICapMod*)IfxCreateParentModule("NSP",iActiveBoard,"nsptest.txt"))) {
		if ((m_pMod=(CICapMod*)IfxCreateParentModule("NSP",iActiveBoard,NULL))) {

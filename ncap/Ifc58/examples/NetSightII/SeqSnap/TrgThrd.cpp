 ...
 *    $Logfile: /ifc/examples/NetSightII/seqsnap/TrgThrd.cpp $
 *    $Revision: 1.1 $
 *    $Modtime: 1/07/04 5:46p $
 *
 * ABSTRACT
...
double current1=CIFCOS::GetSystimeMicrosecs();
double ms=(current1-ExtendedAttr.ArrivalTime)/1000.0;
TRACE("frame ArrivalTime difference current %f ms\n",ms);
...
CVixnEOF::CVixnEOF(PCParentMod pMod) : CVixn(pMod,  P2V_INTR_EOFRM)
{
	m_intrCount = 0;
	m_deltaTime = 0;
	m_iSoftTrig = 1;

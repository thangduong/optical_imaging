 ...
 *    $Logfile: /ifc/examples/NetSightII/intrex/IntrEx.h $
 *    $Revision: 1.1 $
 *    $Modtime: 9/16/04 4:21p $
 *
 * ABSTRACT
...
// max number of NetSightIIs we can handle in the system
...
public:
	...
	// array of ponters to the NetSightII board modules

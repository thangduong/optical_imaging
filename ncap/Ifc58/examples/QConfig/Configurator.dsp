...
# PROP Scc_ProjName ""$/ifc/examples/QuickConfig", PVOAAAAA"
# PROP Scc_LocalPath "."
CPP=cl.exe
MTL=midl.exe
RSC=rc.exe
...
# ADD LINK32 /nologo /subsystem:windows /machine:I386 /out:"Release\QConfig.exe" /libpath:"../../host/win32/lib" /libpath:"../../lib"
...
# ADD LINK32 /nologo /subsystem:windows /debug /machine:I386 /out:"Debug\QConfig.exe" /pdbtype:sept /libpath:"../../host/win32/lib" /libpath:"../../lib"

 ...
 *    $Logfile: /ifc/examples/PCVisionplus/IntrEx/INTREX.H $
 *    $Revision: 1.1 $
 *    $Modtime: 8/22/00 7:35p $
 *
 * ABSTRACT
...
// max number of PCRGBs we can handle in the system
...
public:
	...
	// array of ponters to the PCRGB board modules

 ...
 *    $Logfile: /ifc/examples/PCVisionplus/SeqSnap/SEQSNAPV.H $
 *    $Revision: 1.1 $
 *    $Modtime: 7/20/00 10:43a $
 *
 * ABSTRACT
...
protected:
	...
	afx_msg void OnCmdsOverSample();
	afx_msg void OnUpdateOverSampleUI(CCmdUI* pCmdUI);
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};

 ...
 *    $Logfile: /ifc/examples/PCVisionplus/SeqSnap/SEQSNAP.CPP $
 *    $Revision: 1.1 $
 *    $Modtime: 1/23/04 10:20a $
 *
 * ABSTRACT
...
void CSeqsnapApp::InitIFC(void)
{
	...
	if (!(m_iCap=IfxCreateCaptureModule("PCP",m_iActiveBoard, "pcptest.txt"))) {
		if (!(m_iCap=IfxCreateCaptureModule("PCP",m_iActiveBoard))) {

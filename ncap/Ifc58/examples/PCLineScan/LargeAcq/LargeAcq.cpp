 ...
 *    $Logfile: /ifc/examples/LineScan/LargeAcq/LargeAcq.cpp $
 *    $Revision: 1.1 $
 *    $Modtime: 3/22/00 3:30p $
 *
 * ABSTRACT
...
BOOL CLargeAcqApp::IFCInit()
{
	...
	if (!(m_pMod=IfxCreateCaptureModule("PCL",0,"pcltest.txt"))) {
		if (!(m_pMod=IfxCreateCaptureModule("PCL",0,NULL))) {

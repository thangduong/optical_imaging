...
"$(INTDIR)\BlobAnlz.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\seqsnap.pch"


!ELSEIF  "$(CFG)" == "seqsnap - Win32 Debug"


"$(INTDIR)\BlobAnlz.obj"	"$(INTDIR)\BlobAnlz.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\seqsnap.pch"
...
"$(INTDIR)\FlatFld.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\seqsnap.pch"


!ELSEIF  "$(CFG)" == "seqsnap - Win32 Debug"


"$(INTDIR)\FlatFld.obj"	"$(INTDIR)\FlatFld.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\seqsnap.pch"

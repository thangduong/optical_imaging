 ...
 *    $Logfile: /ifc/examples/LineScan/PulseGen/PulseGen.cpp $
 *    $Revision: 1.1 $
 *    $Modtime: 3/22/00 3:38p $
 *
 * ABSTRACT
...
BOOL CPulseGenApp::InitInstance()
{
	...
	if (!(m_pMod=(CICapMod*)IfxCreateParentModule("PCL",iActiveBoard,"pcltest.txt"))) {
		if ((m_pMod=(CICapMod*)IfxCreateParentModule("PCL",iActiveBoard,NULL))) {

 ...
 *		$Logfile: /ifc/examples/PcRgb/IntrEx/INTRDLG.CPP $
 *		$Revision: 1.1 $
 *		$Modtime: 3/23/01 2:26p $
 *
 * ABSTRACT  
	...
	: CDialog(CIntrExDlg::IDD, pParent)
{
	...
	m_bGrabActive = FALSE;
	m_lCounterGotEvenVB = 0;
	m_lCounterGotOddVB = 0;
	m_lCounterGotVB = 0;
	//}}AFX_DATA_INIT
...
BEGIN_MESSAGE_MAP(CIntrExDlg, CDialog)
	...
	ON_WM_TIMER()
	ON_WM_CLOSE()
	ON_CONTROL_RANGE(BN_CLICKED, IDC_BUTTON1, IDC_BUTTON1A, OnButton)

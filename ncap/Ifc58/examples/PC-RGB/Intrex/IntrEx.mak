...
"$(INTDIR)\triggrabdlg.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\IntrEx.pch"


!ELSEIF  "$(CFG)" == "IntrEx - Win32 Debug"


"$(INTDIR)\triggrabdlg.obj"	"$(INTDIR)\triggrabdlg.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\IntrEx.pch"

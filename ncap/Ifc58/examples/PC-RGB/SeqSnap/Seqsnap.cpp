 ...
 *    $Logfile: /ifc/examples/PcRgb/SEQSNAP/SEQSNAP.CPP $
 *    $Revision: 1.1 $
 *    $Modtime: 10/27/99 4:08p $
 *
 * ABSTRACT
...
void CSeqsnapApp::InitIFC(void)
{
	...
	if (!(m_iCap=IfxCreateCaptureModule("PCR",m_iActiveBoard, "pcrtest.txt"))) {
		if (!(m_iCap=IfxCreateCaptureModule("PCR",m_iActiveBoard))) {

 ...
 *    $Logfile: /ifc/examples/PCVision/Seqsnap/seqsnap.cpp $
 *    $Revision: 1.1 $
 *    $Modtime: 10/22/99 10:37a $
 *
 * ABSTRACT
...
void CSeqsnapApp::InitIFC(void)
{
	...
	if (!(m_iCap=IfxCreateCaptureModule("ICP",m_iActiveBoard, "pcvtest.txt"))) {
		if (!(m_iCap=IfxCreateCaptureModule("ICP",m_iActiveBoard))) {

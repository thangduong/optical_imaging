...
!IF "$(CESubsystem)" == ""
CESubsystem=windowsce,2.11
!MESSAGE Variable CESubsystem not specified. Defaulting to windowsce,2.10
!ENDIF 

!IF "$(CEVersion)" == ""
CEVersion=211
!MESSAGE Variable CEVersion not specified. Defaulting to 210
!ENDIF 

!IF "$(CEConfigName)" == ""
CEConfigName=Jupiter
!MESSAGE Variable CEConfigName not specified.  Defaulting to Jupiter
!ENDIF 

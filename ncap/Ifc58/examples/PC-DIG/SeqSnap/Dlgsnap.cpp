 ...
 *    $Logfile: /ifc/examples/pcdig/SEQSNAP/Dlgsnap.cpp $
 *    $Revision: 1.1 $
 *    $Modtime: 10/09/03 6:00p $
 *
 * ABSTRACT
...
BOOL CDlgsnap::OnInitDialog() 
{
	...
	m_ImgConn = new CImgConn(m_imgBuf,(WORD)m_areaDx,(WORD)m_areaDy,(WORD)attr.dwBitsPerPixel, m_vparent->m_hWnd,attr.color,imgConnFlags);
...
void CDlgsnap::OnSnap() 
{
	...
	theapp->m_cam->SeqSnap(m_imgBuf,m_vparent->m_numSnapAreas,0,0,(short)m_areaDx,(short)m_areaDy);

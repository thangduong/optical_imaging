 ...
 *		$Logfile: /ifc/examples/pcdig/intrex/INTREX.H $
 *		$Revision: 1.1 $
 *		$Modtime: 4/26/99 5:32p $
 *
 * ABSTRACT  
...
// max number of PCDigs we can handle in the system
...
public:
	...
	// array of ponters to the PCDIG board modules

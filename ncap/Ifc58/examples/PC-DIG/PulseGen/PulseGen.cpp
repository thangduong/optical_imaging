 ...
 *    $Logfile: /ifc/examples/pcdig/PulseGen/PulseGen.cpp $
 *    $Revision: 1.1 $
 *    $Modtime: 6/30/99 11:22a $
 *
 * ABSTRACT
...
BOOL CPulseGenApp::InitInstance()
{
	...
	if (!(m_pMod=(CICapMod*)IfxCreateParentModule("PCD",iActiveBoard,"pcdtest.txt"))) {
		if ((m_pMod=(CICapMod*)IfxCreateParentModule("PCD",iActiveBoard,NULL))) {

 ...
 *    $Logfile: /ifc/examples/BanditII/SeqSnap/MainFrm.cpp $
 *    $Revision: 1.1 $
 *    $Modtime: 10/18/02 6:35p $
 *
 * ABSTRACT
 ...
 *
 *
 * Copyright (c) 2001-2002 Coreco Imaging, Inc.  All rights reserved.
 *
 ******************************************************************************/
...
CMainFrame::CMainFrame()
{
	...
	m_bandit=(CBanditII*)theApp->m_iCap;
...
{
//	pCmdUI->Enable(m_bandit && m_bandit->RgbSupported());
}

void CMainFrame::OnUpdateLutInvert(CCmdUI* pCmdUI) 
{
	pCmdUI->Enable(m_bandit && m_bandit->ActiveIsRgbPort());
}

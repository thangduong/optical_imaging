 ...
 *    $Logfile: /ifc/examples/BanditII/SeqSnap/seqsnap.cpp $
 *    $Revision: 1.1 $
...
void CSeqsnapApp::InitIFC(void)
{
	...
	if (!(m_iCap=IfxCreateCaptureModule("BDT",m_iActiveBoard, "bdttest.txt"))) {
		if (!(m_iCap=IfxCreateCaptureModule("BDT",m_iActiveBoard))) {

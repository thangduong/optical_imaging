 ...
 *    $Logfile: /ifc/examples/PC2-CamLink/Seqsnap/seqsnap.cpp $
 *    $Revision: 1.1 $
 *    $Modtime: 6/16/03 2:23p $
 *
 * ABSTRACT
...
void CSeqsnapApp::InitIFC(void)
{
	...
	if (!(m_iCap=IfxCreateCaptureModule("CL2",m_iActiveBoard,"cl2test.txt"))) {
		if (!(m_iCap=IfxCreateCaptureModule("CL2",m_iActiveBoard))) {

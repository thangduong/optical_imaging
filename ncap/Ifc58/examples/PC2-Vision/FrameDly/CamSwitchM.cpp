 ...
 *    $Logfile: /ifc/examples/PC2-Vision/FrameDly/CamSwitchM.cpp $
 *    $Revision: 1.1 $
 *    $Modtime: 5/13/03 11:02a $
 *
 * ABSTRACT
 ...
 *
 *
 * Copyright (c) 2000-2003 Coreco Imaging , Inc.  All rights reserved.
 *
 ******************************************************************************/
	...
	: CDialog(CCamSwitchM::IDD, pParent)
{
	...
	CFrameDlyView *parent = (CFrameDlyView*)pParent;
	
	//{{AFX_DATA_INIT(CCamSwitchM)
	m_trigSrc = parent->m_trigSrc;
	//}}AFX_DATA_INIT
	m_NbCamera = parent->m_numCameras;
...
void CCamSwitchM::DoDataExchange(CDataExchange* pDX)
{
   ...
   DDX_Text(pDX, IDC_NB_CAMERA, m_NbCamera);
	DDX_Radio(pDX, IDC_TRIG_SRC, m_trigSrc);
	//}}AFX_DATA_MAP

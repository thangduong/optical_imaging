 ...
 *    $Logfile: /ifc/examples/PC2-Vision/PulseGen/PulseGen.cpp $
 *    $Revision: 1.1 $
 *    $Modtime: 4/05/04 1:59p $
 *
 * ABSTRACT
...
BOOL CPulseGenApp::InitInstance()
{
	...
	if (!(m_pMod=(CICapMod*)IfxCreateParentModule("P2V",iActiveBoard,"p2vtest.txt"))) {
		if ((m_pMod=(CICapMod*)IfxCreateParentModule("P2V",iActiveBoard,NULL))) {

...
//
//  FILE:           IFC_PC2V_BasicGrabDlg.cpp
//
...
//              Constructor
//------------------------------------------
CIFC_PC2V_BasicGrabDlg::CIFC_PC2V_BasicGrabDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CIFC_PC2V_BasicGrabDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CIFC_PC2V_BasicGrabDlg)
	//}}AFX_DATA_INIT
...
void CIFC_PC2V_BasicGrabDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CIFC_PC2V_BasicGrabDlg)
...
BEGIN_MESSAGE_MAP(CIFC_PC2V_BasicGrabDlg, CDialog)
	//{{AFX_MSG_MAP(CIFC_PC2V_BasicGrabDlg)
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
//              OnInitDialog
//------------------------------------------
BOOL CIFC_PC2V_BasicGrabDlg::OnInitDialog()
{
...
//              InitIFC_Capture
//------------------------------------------
BOOL CIFC_PC2V_BasicGrabDlg::InitIFC_Capture()
{
CAM_ATTR attrib;
    ...
    m_pBrdMod = IfxCreateCaptureModule("P2V", 0, "p2vtest.txt");       // Use PC2-Vsion board # 0
    if (m_pBrdMod == NULL)
    {
        // Failed to find and use the default configuration file "p2vtest.txt"
        // Ask user to select a camera type

        m_pBrdMod = IfxCreateCaptureModule("P2V", 0);       // Use PC2-Vision board # 0
        if (m_pBrdMod == NULL)
        {
...
//------------------------------------------
CImgConn *CIFC_PC2V_BasicGrabDlg::InitIFC_ImageConnection(HWND hWnd, CICamera *cam)
{
CImgConn *ImgConn;
...
//         ReleaseIFC_Capture
//------------------------------------------
void CIFC_PC2V_BasicGrabDlg::ReleaseIFC_Capture()
{
...
//------------------------------------------
void CIFC_PC2V_BasicGrabDlg::ReleaseIFC_ImageConnection()
{
...
//------------------------------------------
void CIFC_PC2V_BasicGrabDlg::OnPaint() 
{
	if (IsIconic())
	{
...
//------------------------------------------
HCURSOR CIFC_PC2V_BasicGrabDlg::OnQueryDragIcon()
{
...
//              ReleaseAll
//------------------------------------------
void CIFC_PC2V_BasicGrabDlg::ReleaseAll()
{
...
//              SetPortAndCamType
//------------------------------------------
void CIFC_PC2V_BasicGrabDlg::SetPortAndCamType(DWORD dwActivePort, char *pszCamType)
{
CAM_ATTR attr;
CString strToShow;
...
//              ClearDisplay
//------------------------------------------
void CIFC_PC2V_BasicGrabDlg::ClearDisplay()
{
CClientDC MyDC(this);
CBrush *pOldBrush;
RECT RectDraw;
...
//------------------------------------------
BOOL CIFC_PC2V_BasicGrabDlg::GetWindowPosition(HWND hWnd, LPRECT lpRect)
{
RECT  WinPosition;
...
//              OnButtonCam
//------------------------------------------
void CIFC_PC2V_BasicGrabDlg::OnButtonCam() 
{
...
//              OnButtonFreeze
//------------------------------------------
void CIFC_PC2V_BasicGrabDlg::OnButtonFreeze() 
{
    m_pCam->Freeze();
    m_bIsGrabbing = FALSE;
}
...
//              OnButtonGrab
//------------------------------------------
void CIFC_PC2V_BasicGrabDlg::OnButtonGrab() 
{
...
//              OnButtonSnap
//------------------------------------------
void CIFC_PC2V_BasicGrabDlg::OnButtonSnap() 
{
    if (m_bIsGrabbing)
    {
...
//              OnTimer
//------------------------------------------
void CIFC_PC2V_BasicGrabDlg::OnTimer(UINT nIDEvent) 
{
CString strToShow;
...
//              ShowStatistics
//------------------------------------------
void CIFC_PC2V_BasicGrabDlg::ShowStatistics() 
{
double dFrameRate;
CString strToShow;
...
//              UpdateButtons
//------------------------------------------
void CIFC_PC2V_BasicGrabDlg::UpdateButtons()
{
...
//              OnClose
//------------------------------------------
void CIFC_PC2V_BasicGrabDlg::OnClose() 
{
CString strWarnText;
...
//  view window.
//------------------------------------------
void CIFC_PC2V_BasicGrabDlg::DrawWindowBorder(HWND hWnd)
{
CClientDC MyDC(this);
...
//              OnButtonTrap
//------------------------------------------
void CIFC_PC2V_BasicGrabDlg::OnButtonTrap() 
{
...
//              OnButtonTrigger
//------------------------------------------
void CIFC_PC2V_BasicGrabDlg::OnButtonTrigger() 
{

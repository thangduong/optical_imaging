...
void CConnSelDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_CONNECTOR_GRP1, m_ButtonConn0);
	DDX_Control(pDX, IDC_CONNECTOR_GRP2, m_ButtonConn1);
	//}}AFX_DATA_MAP
}
...
BEGIN_MESSAGE_MAP(CConnSelDlg, CDialog)
	...
	ON_BN_CLICKED(IDC_CONNECTOR_GRP1, OnConnector0)
	ON_BN_CLICKED(IDC_CONNECTOR_GRP2, OnConnector1)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

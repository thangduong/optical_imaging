 ...
 *    $Logfile: /ifc/examples/PC2-Vision/3Cam1Grab/TrgThrd.cpp $
 *    $Revision: 1.1 $
 *    $Modtime: 9/29/03 8:54a $
 *
 * ABSTRACT
...
DWORD WINAPI TriggerThread(LPVOID owner)
{
	...
	grabID = cam->Grab(IFC_GOPT_AUTO_FRAME_LOCK, theapp->m_imgBuf, FRAMES_IN_HOSTBUFF*NUM_CAMERAS);

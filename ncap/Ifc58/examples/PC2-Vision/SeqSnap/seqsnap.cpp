 ...
 *    $Logfile: /ifc/examples/PCVision2/SeqSnap/seqsnap.cpp $
 *    $Revision: 1.1 $
 *    $Modtime: 10/02/02 4:02p $
 *
 * ABSTRACT
...
void CSeqsnapApp::InitIFC(void)
{
	...
	if (!(m_iCap=IfxCreateCaptureModule("P2V",m_iActiveBoard, "p2vtest.txt"))) {
		if (!(m_iCap=IfxCreateCaptureModule("P2V",m_iActiveBoard))) {

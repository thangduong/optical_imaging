 ...
 *    $Logfile: /ifc/examples/CamLink/LargeAcq/LargeAcqView.cpp $
 *    $Revision: 1.1 $
 *    $Modtime: 4/17/02 2:05p $
 *
 * ABSTRACT
 *    CamLink Large Frame Acquisition Example Program
 *	This program shows how the CamLink can be used to acquire very large frames.

 ...
 *    $Logfile: /ifc/examples/CamLink/LargeAcq/LargeAcq.cpp $
 *    $Revision: 1.1 $
 *    $Modtime: 5/18/01 9:12a $
 *
 * ABSTRACT
...
BOOL CLargeAcqApp::IFCInit()
{
	...
	if (!(m_pMod=IfxCreateCaptureModule("LNK",0,"lnktest.txt"))) {
		if (!(m_pMod=IfxCreateCaptureModule("LNK",0,NULL))) {

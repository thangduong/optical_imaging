 ...
 *		$Logfile: /ifc/examples/CamLink/intrex/IntrEx.h $
 *		$Revision: 1.1 $
...
// max number of PCLinks we can handle in the system
...
public:
	...
	// array of ponters to the PCLink board modules
	...
	LNK_TRIG_MODE_TYPE m_startEvent , m_stopEvent;

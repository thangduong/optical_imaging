 ...
 *    $Logfile: /ifc/examples/CamLink/seqsnap/seqsnap.cpp $
 *    $Revision: 1.1 $
...
void CSeqsnapApp::InitIFC(void)
{
	...
	if (!(m_iCap=IfxCreateCaptureModule("LNK",m_iActiveBoard,"lnktest.txt"))) {
		if (!(m_iCap=IfxCreateCaptureModule("LNK",m_iActiveBoard))) {

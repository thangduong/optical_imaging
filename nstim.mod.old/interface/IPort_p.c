    ...
    const unsigned char __RPC_FAR *name)
{
    ...
    RpcTryExcept
        ...
        RpcTryFinally
            ...
            *(( unsigned char __RPC_FAR * )_StubMsg.Buffer)++ = *name;
...
NdrStubInitialize(
    ...
    RpcTryFinally
        ...
        name = ( unsigned char __RPC_FAR * )_StubMsg.Buffer;
        _StubMsg.Buffer += sizeof( unsigned char  );
        
        
        *_pdwStubPhase = STUB_CALL_SERVER;
        _RetVal = (((IPort*) ((CStdStubBuffer *)This)->pvServerObject)->lpVtbl) -> Open((IPort *) ((CStdStubBuffer *)This)->pvServerObject,name);
...
NdrStubInitialize(
    ...
    RpcTryFinally
        ...
        *_pdwStubPhase = STUB_CALL_SERVER;
        _RetVal = (((IPort*) ((CStdStubBuffer *)This)->pvServerObject)->lpVtbl) -> Close((IPort *) ((CStdStubBuffer *)This)->pvServerObject);
...
NdrStubInitialize(
    ...
    RpcTryFinally
        ...
        *_pdwStubPhase = STUB_CALL_SERVER;
        _RetVal = (((IPort*) ((CStdStubBuffer *)This)->pvServerObject)->lpVtbl) -> IsOpen((IPort *) ((CStdStubBuffer *)This)->pvServerObject);
    ...
    unsigned long dwDataSize)
{
    ...
    RpcTryExcept
        ...
        RpcTryFinally
            ...
            *(( unsigned long __RPC_FAR * )_StubMsg.Buffer)++ = dwDataSize;
...
NdrStubInitialize(
    ...
    RpcTryFinally
        ...
        _StubMsg.Buffer = (unsigned char __RPC_FAR *)(((long)_StubMsg.Buffer + 3) & ~ 0x3);
        dwDataSize = *(( unsigned long __RPC_FAR * )_StubMsg.Buffer)++;
        
        
        *_pdwStubPhase = STUB_CALL_SERVER;
        _RetVal = (((IPort*) ((CStdStubBuffer *)This)->pvServerObject)->lpVtbl) -> Send(
        (IPort *) ((CStdStubBuffer *)This)->pvServerObject,
        pData,
        dwDataSize);
...
NdrStubInitialize(
    ...
    RpcTryFinally
        ...
        *_pdwStubPhase = STUB_CALL_SERVER;
        _RetVal = (((IPort*) ((CStdStubBuffer *)This)->pvServerObject)->lpVtbl) -> RegisterCallback((IPort *) ((CStdStubBuffer *)This)->pvServerObject,pCallback);
...
NdrStubInitialize(
    ...
    RpcTryFinally
        ...
        *_pdwStubPhase = STUB_CALL_SERVER;
        _RetVal = (((IPort*) ((CStdStubBuffer *)This)->pvServerObject)->lpVtbl) -> UnregisterCallback((IPort *) ((CStdStubBuffer *)This)->pvServerObject,pCallback);
...
const CINTERFACE_PROXY_VTABLE(9) _IPortProxyVtbl = 
{
    &IID_IPort,
    ...
    IPort_IsOpen_Proxy ,
    IPort_Send_Proxy ,
    IPort_RegisterCallback_Proxy ,
    IPort_UnregisterCallback_Proxy
};
...
static const PRPC_STUB_FUNCTION IPort_table[] =
{
    ...
    IPort_IsOpen_Stub,
    IPort_Send_Stub,
    IPort_RegisterCallback_Stub,
    IPort_UnregisterCallback_Stub
};

const CInterfaceStubVtbl _IPortStubVtbl =
{
    &IID_IPort,
    0,
    9,
...
/*  8 */	NdrFcLong( 0x1709f049 ),	/* 386527305 */
/* 12 */	NdrFcShort( 0x59f6 ),	/* 23030 */
/* 14 */	NdrFcShort( 0x479d ),	/* 18333 */
/* 16 */	0xbb,		/* 187 */
			0xb,		/* 11 */
/* 18 */	0xc9,		/* 201 */
			0x10,		/* 16 */
...
const CInterfaceProxyVtbl * _IPort_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IPortProxyVtbl,
    0
};

const CInterfaceStubVtbl * _IPort_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IPortStubVtbl,
    0
};

PCInterfaceName const _IPort_InterfaceNamesList[] = 
{
    "IPort",
    0
};
...
#define _IPort_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _IPort, pIID, n)

int __stdcall _IPort_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_IPort_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo IPort_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _IPort_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _IPort_StubVtblList,
    (const PCInterfaceName * ) & _IPort_InterfaceNamesList,
    0, // no delegation
    & _IPort_IID_Lookup, 
    1,
    1,

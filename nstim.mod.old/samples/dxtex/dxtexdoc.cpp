...
void CdxtexDoc::OpenCubeFace(D3DCUBEMAP_FACES FaceType)
{
    ...
    if (m_numMips > 1)
    {
        hr = D3DXFilterCubeTexture((LPDIRECT3DCUBETEXTURE9)m_ptexOrig, NULL, 0, D3DX_FILTER_TRIANGLE);
    }
    ...
    if (psurfNew != NULL)
    {
        ...
        if (m_numMips > 1)
        {
            hr = D3DXFilterCubeTexture((LPDIRECT3DCUBETEXTURE9)m_ptexNew, NULL, 0, D3DX_FILTER_TRIANGLE);
        }
    }

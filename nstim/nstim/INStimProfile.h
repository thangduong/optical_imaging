...
EXTERN_C const IID IID_INStimProfile;
    ...
    public:
        ...
        virtual HRESULT STDMETHODCALLTYPE GetLogPath( 
    ...
    typedef struct INStimProfileVtbl
    {
        ...
        HRESULT ( STDMETHODCALLTYPE __RPC_FAR *GetLogPath )( 
            INStimProfile __RPC_FAR * This,
...
#define INStimProfile_GetLogPath(This,pLogPath)	\
    (This)->lpVtbl -> GetLogPath(This,pLogPath)
